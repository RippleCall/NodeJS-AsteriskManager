...
var Manager = function Manager(port, host, username, password, events, backoff=10000) {
...
function ManagerReconnect(context) {
  ...
  if(context.backoff < 6000){ //The maximum reconection time is 60 seconds
    context.backoff += 1000; //Increase reconnection time by 10 seconds
  }
}
